...
详细的插件开发指南请参阅 [docs/plugin-development.md](docs/design/plugin-development.md)。
...
- [插件开发指南](docs/design/plugin-development.md) — 完整的插件创建流程
- [配置参考](docs/design/config-reference.md) — 配置文件格式说明
- [日常工作流指南](docs/design/daily-workflow-guide.md) — 使用场景与 Skill 速查
